      ...
      <div className="contact-page-layout">
        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <a href="mailto:info@bharatinnovations.co" style={{ display: "flex", alignItems: "center", gap: "0.65rem", color: "rgba(255,255,255,0.8)", textDecoration: "none", fontSize: "0.88rem" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e0a695" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
